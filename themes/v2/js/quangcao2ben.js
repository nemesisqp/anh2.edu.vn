...
{
	startX = document.body.clientWidth - 115, startY = 60;
	var ns = (navigator.appName.indexOf("Netscape") != -1);
	var d = document;
		
	if (document.body.clientWidth < 980) startX = -120;
	...
	window.stayTopLeft=function()
	{
		...
		if (document.body.scrollTop > 80){startY = 3; } else {startY = 60 - document.body.scrollTop;};
		
		if (document.body.clientWidth >= 1024)
		{
			ftlObj.x = document.body.clientWidth - 122;ftlObj.y += (pY + startY - ftlObj.y)/32;ftlObj.sP(ftlObj.x, ftlObj.y);
		}
		else
		{
...
{
	startX2 = document.body.clientWidth - 1004, startY2 = 60;
	var ns2 = (navigator.appName.indexOf("Netscape") != -1);
	var d2 = document;
		
	if (document.body.clientWidth < 980) startX2 = -120;
	...
	window.stayTopLeft2=function()
	{
		...
		if (document.body.scrollTop > 80){startY2 = 3} else {startY2 = 60 - document.body.scrollTop;};
